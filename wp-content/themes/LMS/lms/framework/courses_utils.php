...
if($courses_type != 'popular') {
	...
	$args = array( 'offset'=>$offset, 'paged' => $curr_page ,'posts_per_page' => $post_per_page,'post_type' => 'dt_courses','meta_query'=>array(), 'tax_query'=>array(), 'orderby' => 'menu_order', 'order' => 'ASC', 'suppress_filters' => 'false');
