      ...
      <section id="primary" class="content-full-width"><?php
          ...
          <?php echo $container_middle;
				...
				if( array_key_exists("sub-title",$portfolio_settings) ):
					echo '<h3>'.$portfolio_settings["sub-title"].'</h3>';
				endif;
                ...
                <?php if( isset( $portfolio_settings["client-name"] ) ): ?>
                		<p> <span> <?php _e("Client","dt_themes");?> : </span>  <?php echo $portfolio_settings["client-name"];?></p>
                <?php endif;
                ...
                <?php if( isset( $portfolio_settings["website-link"] ) ): ?>
                		<a class="dt-sc-button" title="" target="_blank" href="<?php echo $portfolio_settings["website-link"];?>"> <span class="fa fa-globe"> </span><?php _e('See it Online','dt_themes');?></a>
                <?php endif;?>
