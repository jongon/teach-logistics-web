        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('dt-sc-course-single'); ?>>
                    ...
                    <div class="entry-metadata">
						...
						if($starting_price != ''): 
							if ( current_user_can($s2_level) ){
								...
								if(dttheme_option('dt_course','currency-position') == 'after-price') $price = $price.dttheme_option('dt_course','currency'); 
								else $price = dttheme_option('dt_course','currency').$price; 
            ...
            <section class="entry">
                ...
                <?php if(isset($course_settings['referrrence_url'])): ?>
                    <?php echo '<strong>'.__('Referrrence URL: ','dt_themes').'</strong><a href="'.$course_settings['referrrence_url'].'">'.$course_settings['referrrence_url'].'</a>';?>
                <?php endif;?>
			...
			if(isset($course_video) && $course_video != '') { ?>
                ...
                <div class="course-video"><?php if(wp_oembed_get( $course_video ) != '') echo wp_oembed_get( $course_video ); else echo apply_filters( 'the_content', $course_video ); ?></div>
                <div class="dt-sc-clear"></div>
